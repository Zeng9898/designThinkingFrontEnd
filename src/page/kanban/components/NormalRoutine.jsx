...
const NormalRoutine = ({ routine, index }) => {
    return (
        ...
        <section className={`bg-white rounded-sm mb-[8px] min-h-[138px] min-w-[242px] mx-[10px] flex justify-start flex-col p-[20px] pt-[5px] border-2 border-l-8 border-solid ${routine.stackId === '待審核' ? "border-myPink1" : "border-myPink2"}`}>
